...
p1 <- as.character(read.table("../../pop1_starch.xls")[[1]])
p2 <- as.character(read.table("../../pop2_european.xls")[[1]])
p3 <- as.character(read.table("../../pop3_american.xls")[[1]])

GENOME.class <- set.populations(GENOME.class,list(p1, p2, p3), diploid=FALSE)
